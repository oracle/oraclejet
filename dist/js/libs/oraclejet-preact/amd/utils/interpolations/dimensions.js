define(['exports', '@oracle/oraclejet-preact/utils/stringLiteralArray', '@oracle/oraclejet-preact/utils/units'], (function (exports, stringLiteralArray, units) { 'use strict';
   ...
   */
  const size = (n) => !units.isNumber(n) || n > 1 ? units.px(n) : n === 0 ? "0" : `${n * 100}%`;
  //export default size;
  ...
  const dimensions = stringLiteralArray.stringLiteralArray([
      "height",
      "maxHeight",
      "maxWidth",
      "minHeight",
  ...
  exports.dimensionInterpolations = interpolations;
