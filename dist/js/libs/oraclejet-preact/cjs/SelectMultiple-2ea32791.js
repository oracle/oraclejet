...
var ListView = require('./ListView-7db989a7.js');
...
var Chip = require('./Chip-b6236b18.js');
...
function DefaultList({
  ...
  return jsxRuntime.jsx(ListView.ListView, Object.assign({
...
function Dropdown({
  ...
  hooks_UNSAFE_useOutsideClick["default"]({
    isDisabled: !isOpen,
  ...
  return !isOpen ? null : jsxRuntime.jsx(UNSAFE_Layer.Layer, {
...
function DropdownArrow({
  ...
  const styleClasses = classNames.classNames([rootStyles$2.base, size === 'sm' ? rootStyles$2.sizeSm : rootStyles$2.sizeMd, isDisabled ? rootStyles$2.disabled : rootStyles$2.enabled]);
...
function DropdownList({
  ...
  const styleClasses = classNames.classNames([rootStyles$1.base, rootStyles$1.listView, isLoading && rootStyles$1.loading]);
  return jsxRuntime.jsx("div", Object.assign({
    class: styleClasses
  }, {
    children: children
...
const SelectMultiple = compat.forwardRef(({ assistiveText, data: propData, helpSourceLink, helpSourceText, id: propId, isDisabled: propIsDisabled, isLoading: propIsLoading, isReadonly: propIsReadonly, isRequired = false, isRequiredShown, itemText, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, messages, onCommit, onFilter, onLoadRange: propOnLoadRange, placeholder, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, valueItems, virtualKeyboard }, ref) => {
    ...
    const dropdownArrow = (jsxRuntime.jsx(DropdownArrow, Object.assign({ isDisabled: isDisabled, size: hasInsideLabel ? 'md' : 'sm' }, dropdownArrowEventHandlers)));
    const selectedValuesCount = valueItems === null || valueItems === void 0 ? void 0 : valueItems.length;
...
/*  */
//# sourceMappingURL=SelectMultiple-2ea32791.js.map
