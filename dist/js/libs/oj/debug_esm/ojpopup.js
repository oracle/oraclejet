...
(function () {
  ...
  oj.__registerWidget('oj.ojPopup', $.oj.baseComponent, {
    ...
    _usingHandler: function (origUsing, pos, props) {
      ...
      if (!tail) {
        ...
        if (props.vertical === 'top') {
          ...
          tailVOffset -= tailVOffset + getCSSLengthAsInt(tail.css(props.vertical));
          // eslint-disable-next-line no-param-reassign
    ...
    _dismissalHandler: function (event) {
      ...
      if (
        !isAncestorOrSelf(launcher[0], target) &&
  ...
  setDefaultOptions({
    ojPopup: {
      modality: createDynamicPropertyGetter(function () {
        return getCachedCSSVarValues(['--oj-private-popup-global-modality-default'])[0];
      }),
      animation: createDynamicPropertyGetter(function () {
