...
(function () {
  ...
  oj.__registerWidget('oj.ojMasonryLayout', $.oj.baseComponent, {
    ...
    _startAnimation: function (elem, action) {
      var defaults = (parseJSONFromFontFamily('oj-masonrylayout-option-defaults') || {})
        .animation;
    ...
    _handleDragEnter: function (event) {
      ...
      if (relatedTarget) {
        enteringMasonryLayout = elem !== relatedTarget && !isAncestor(elem, relatedTarget);
        ...
        enteringMasonryLayout =
          elemUnderPoint && (elemUnderPoint === elem || isAncestor(elem, elemUnderPoint));
      }
    ...
    _handleDragLeave: function (event) {
      ...
      if (relatedTarget) {
        leavingMasonryLayout = elem !== relatedTarget && !isAncestor(elem, relatedTarget);
      } else {
        // chrome 40.0.2214.111 doesn't set a relatedTarget, so need to use other means
