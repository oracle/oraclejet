const translations = {
  ...
  "oj-converter": {
    ...
    "hint": {
      ...
      "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.hint.detail:::Try again using a format like this: {exampleValue}.))",
      "detail-plural": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.hint.detail-plural:::Enter a value in these formats: {exampleValue}.))"
    },
    "optionHint": {
    ...
    "number": {
      "decimalFormatMismatch": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.number.decimalFormatMismatch.summary:::The provided value is not in the expected number format.))"
      },
      ...
      "currencyFormatMismatch": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.number.currencyFormatMismatch.summary:::The provided value is not in the expected currency format.))"
      },
      "percentFormatMismatch": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.number.percentFormatMismatch.summary:::The provided value is not in the expected percent format.))"
      },
      "invalidNumberFormat": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.number.invalidNumberFormat.summary:::The provided value is not a valid number.))",
        "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.number.invalidNumberFormat.detail:::Please provide valid number.))"
      },
      "parseError": {
        "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.number.parseError.detail:::Enter a number.))"
      }
    },
    "color": {
      "invalidFormat": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.color.invalidFormat.summary:::Invalid color format.))",
        "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.color.invalidFormat.detail:::Invalid color format option specification.))"
      },
      "invalidSyntax": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.color.invalidSyntax.summary:::Invalid color specification.))",
        "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.color.invalidSyntax.detail:::Enter a color value that conforms to the CSS3 standard.))"
      }
    },
    "datetime": {
      "datetimeOutOfRange": {
      ...
      "dateFormatMismatch": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.datetime.dateFormatMismatch.summary:::The provided value is not in the expected date format.))"
      },
      "invalidTimeZoneID": {
      ...
      "timeFormatMismatch": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.datetime.timeFormatMismatch.summary:::The provided value is not in the expected time format.))"
      },
      "datetimeFormatMismatch": {
        "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.datetime.datetimeFormatMismatch.summary:::The provided value is not in the expected date and time format.))"
      },
      ...
      "invalidISOString": {
        "invalidRangeSummary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-converter.datetime.invalidISOString.invalidRangeSummary:::The value '{value}' is out of range for the '{propertyName}' field in the ISO 8601 string '{isoStr}'.))",
  ...
  "oj-validator": {
    "length": {
      "hint": {
        ...
        "inRange": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.length.hint.inRange:::Enter {min} to {max} characters.))",
        "exact": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.length.hint.exact:::Enter {length} characters.))"
      },
      "messageDetail": {
        "tooShort": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.length.messageDetail.tooShort:::Enter {min} or more characters.))",
        "tooLong": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.length.messageDetail.tooLong:::Enter no more than {max} characters.))"
      },
      "messageSummary": {
    ...
    "range": {
      "number": {
        ...
        "messageDetail": {
          "rangeUnderflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.number.messageDetail.rangeUnderflow:::Enter a number that's {min} or higher.))",
          "rangeOverflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.number.messageDetail.rangeOverflow:::Enter a number that's {max} or lower.))",
          "exact": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.number.messageDetail.exact:::Enter the number {num}.))"
        },
        "messageSummary": {
      ...
      "datetime": {
        ...
        "messageDetail": {
          "rangeUnderflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.datetime.messageDetail.rangeUnderflow:::Enter a date and time that's on or after {min}.))",
          "rangeOverflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.datetime.messageDetail.rangeOverflow:::Enter a date and time that's on or before {max}.))"
        },
        "messageSummary": {
      ...
      "date": {
        ...
        "messageDetail": {
          "rangeUnderflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.date.messageDetail.rangeUnderflow:::Enter a date that's on or after {min}.))",
          "rangeOverflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.date.messageDetail.rangeOverflow:::Enter a date that's on or before {max}.))"
        },
        "messageSummary": {
      ...
      "time": {
        ...
        "messageDetail": {
          "rangeUnderflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.time.messageDetail.rangeUnderflow:::Enter a time that's {min} or later.))",
          "rangeOverflow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.range.time.messageDetail.rangeOverflow:::Enter a time that's {max} or earlier.))"
        },
        "messageSummary": {
    ...
    "restriction": {
      "date": {
        ...
        "messageDetail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.restriction.date.messageDetail:::The date you selected isn't available. Try another date.))"
      }
    },
    "regExp": {
      "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.regExp.summary:::Format is incorrect.))",
      "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.regExp.detail:::Enter allowable values described in this regular expression: '{pattern}'.))"
    },
    "required": {
      "summary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.required.summary:::Value is required.))",
      "detail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-validator.required.detail:::Enter a value.))"
    }
  },
  "oj-ojEditableValue": {
    "loading": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojEditableValue.loading:::Loading))",
    "requiredText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojEditableValue.requiredText:::Required))",
    "helpSourceText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojEditableValue.helpSourceText:::Learn more...))"
  },
  "oj-ojInputDate": {
    ...
    "time": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.time:::Time))",
    "accessibleClearIconAltText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.accessibleClearIconAltText:::Clear input))",
    "prevText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.prevText:::Previous))",
    ...
    "setTime": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.setTime:::Set Time))",
    "setDate": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.setDate:::Set Date))",
    ...
    "dateTimePicker": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.dateTimePicker:::Date and Time Picker))",
    ...
    "accessibleMaxLengthExceeded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.accessibleMaxLengthExceeded:::Maximum length {len} exceeded.))",
    "accessibleMaxLengthRemaining": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputDate.accessibleMaxLengthRemaining:::{chars} characters left.))",
    "regexp": {
      "messageSummary": "",
      "messageDetail": ""
    },
  ...
  "oj-ojInputTime": {
    "accessibleClearIconAltText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputTime.accessibleClearIconAltText:::Clear input))",
  ...
  "oj-inputBase": {
    ...
    "accessibleMaxLengthExceeded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-inputBase.accessibleMaxLengthExceeded:::Maximum length {len} exceeded.))",
    "accessibleMaxLengthRemaining": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-inputBase.accessibleMaxLengthRemaining:::{chars} characters left.))"
  },
  "oj-ojInputText": {
    "accessibleClearIcon": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputText.accessibleClearIcon:::Clear))"
  },
  "oj-ojInputPassword": {
    "regexp": {
    ...
    "accessibleShowPassword": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputPassword.accessibleShowPassword:::Show password.))",
    "accessibleHidePassword": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputPassword.accessibleHidePassword:::Hide password.))"
  },
  "oj-ojFilmStrip": {
  ...
  "oj-ojDataGrid": {
    ...
    "accessibleSortable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleSortable:::{id} sortable))",
    ...
    "accessibleExpanded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleExpanded:::Expanded))",
    ...
    "accessibleCollapsed": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleCollapsed:::Collapsed))",
    ...
    "accessibleRowHeaderLabelContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleRowHeaderLabelContext:::Row Header Label {level}))",
    "accessibleColumnHeaderLabelContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleColumnHeaderLabelContext:::Column Header Label {level}))",
    "accessibleRowEndHeaderLabelContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleRowEndHeaderLabelContext:::Row End Header Label {level}))",
    "accessibleColumnEndHeaderLabelContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleColumnEndHeaderLabelContext:::Column End Header Label {level}))",
    ...
    "accessibleEndOfDataGrid": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleEndOfDataGrid:::End of data grid.))",
    ...
    "accessibleLevelHierarchicalContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleLevelHierarchicalContext:::Level {level}))",
    "accessibleRowHierarchicalFull": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleRowHierarchicalFull:::Row {posInSet} of {setSize} rows))",
    "accessibleRowHierarchicalPartial": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleRowHierarchicalPartial:::Row {posInSet} of at least {setSize} rows))",
    "accessibleRowHierarchicalUnknown": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleRowHierarchicalUnknown:::At least row {posInSet} of at least {setSize} rows))",
    "accessibleColumnHierarchicalFull": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleColumnHierarchicalFull:::Column {posInSet} of {setSize} columns))",
    "accessibleColumnHierarchicalPartial": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleColumnHierarchicalPartial:::Column {posInSet} of at least {setSize} columns))",
    "accessibleColumnHierarchicalUnknown": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleColumnHierarchicalUnknown:::At least column {posInSet} of at least {setSize} columns))",
    "accessibleFilterable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleFilterable:::Filterable))",
    "accessibleFiltered": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleFiltered:::Filtered))",
    ...
    "msgReadOnly": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.msgReadOnly:::This cell is read-only and can't be edited.))",
    "labelHideColumns": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelHideColumns:::Hide Columns))",
    "labelHideRows": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelHideRows:::Hide Rows))",
    "labelUnhideColumns": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelUnhideColumns:::Unhide Columns))",
    "labelUnhideRows": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelUnhideRows:::Unhide Rows))",
    ...
    "labelSortAsc": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelSortAsc:::Sort Ascending))",
    "labelSortDsc": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelSortDsc:::Sort Descending))",
    ...
    "labelFilter": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelFilter:::Filter))",
    "labelFilterCol": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelFilterCol:::Filter Column))",
    ...
    "labelCutCells": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelCutCells:::Cut))",
    "labelPasteCells": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelPasteCells:::Paste))",
    "labelCopyCells": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelCopyCells:::Copy))",
    "labelAutoFill": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelAutoFill:::Autofill))",
    ...
    "labelResizeDialogCancel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelResizeDialogCancel:::Cancel))",
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.accessibleContainsControls:::Contains Controls))",
    "labelSelectMultiple": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelSelectMultiple:::Select Multiple))",
    "labelResizeDialogApply": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelResizeDialogApply:::Apply))",
    "labelResizeFitToContent": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelResizeFitToContent:::Resize to Fit))",
    "columnWidth": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.columnWidth:::Width in Pixels))",
    "rowHeight": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.rowHeight:::Height in Pixels))",
    "labelResizeColumn": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelResizeColumn:::Resize Column))",
    "labelResizeRow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelResizeRow:::Resize Row))",
    "resizeColumnDialog": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.resizeColumnDialog:::Resize column))",
    "resizeRowDialog": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.resizeRowDialog:::Resize row))",
    "labelFreezeRow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelFreezeRow:::Freeze Rows))",
    "labelFreezeCol": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelFreezeCol:::Freeze Columns))",
    "labelUnfreezeRow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelUnfreezeRow:::Unfreeze Rows))",
    "labelUnfreezeCol": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.labelUnfreezeCol:::Unfreeze Columns))",
    "collapsedText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.collapsedText:::Collapse))",
    "expandedText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.expandedText:::Expand))",
    "tooltipRequired": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojDataGrid.tooltipRequired:::Required))"
  },
  "oj-ojRowExpander": {
    ...
    "accessibleRowDescriptionAtLeast": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRowExpander.accessibleRowDescriptionAtLeast:::Level {level}, Row {num} of at least {total}))",
  ...
  "oj-ojStreamList": {
    "msgFetchingData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStreamList.msgFetchingData:::Fetching Data...))"
  },
  "oj-ojListView": {
    "msgFetchingData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.msgFetchingData:::Loading))",
    "msgNoData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.msgNoData:::No items to display.))",
    "msgItemsAppended": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.msgItemsAppended:::{count} items appended to the end.))",
    "msgFetchCompleted": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.msgFetchCompleted:::Loaded))",
    ...
    "accessibleExpandCollapseInstructionText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.accessibleExpandCollapseInstructionText:::Use arrow keys to expand and collapse.))",
    "accessibleGroupExpand": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.accessibleGroupExpand:::Expanded))",
    "accessibleGroupCollapse": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.accessibleGroupCollapse:::Collapsed))",
    ...
    "accessibleSuggestion": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojListView.accessibleSuggestion:::Suggestion))",
  ...
  "oj-ojWaterfallLayout": {
    "msgFetchingData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojWaterfallLayout.msgFetchingData:::Fetching Data...))"
  },
  "oj-_ojLabel": {
  ...
  "oj-ojTable": {
    "accessibleAddRow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleAddRow:::Enter data to add a new row.))",
    "accessibleColumnContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleColumnContext:::Column {index}))",
    "accessibleColumnFooterContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleColumnFooterContext:::Column Footer {index}))",
    "accessibleColumnHeaderContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleColumnHeaderContext:::Column Header {index}))",
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleContainsControls:::Contains Controls))",
    "accessibleColumnsSpan": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleColumnsSpan:::Spans {count} Columns))",
    "accessibleEditableSummary": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleEditableSummary:::Press F2 to focus read only controls or enter to begin editing))",
    "accessibleRowContext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleRowContext:::Row {index}))",
    "accessibleSortable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleSortable:::{id} sortable))",
    "accessibleSortAscending": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleSortAscending:::{id} sorted in ascending order))",
    "accessibleSortDescending": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleSortDescending:::{id} sorted in descending order))",
    "accessibleStateSelected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleStateSelected:::selected))",
    "accessibleStateUnselected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleStateUnselected:::unselected))",
    "accessibleSummaryEstimate": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleSummaryEstimate:::Table with {colnum} columns and more than {rownum} rows))",
    "accessibleSummaryExact": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.accessibleSummaryExact:::Table with {colnum} columns and {rownum} rows))",
    ...
    "labelResizeColumn": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelResizeColumn:::Resize Column))",
    "labelResizePopupSubmit": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelResizePopupSubmit:::OK))",
    "labelResizePopupCancel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelResizePopupCancel:::Cancel))",
    ...
    "labelResizeColumnDialog": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelResizeColumnDialog:::Resize column))",
    "labelColumnWidth": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelColumnWidth:::Width in Pixels))",
    "labelResizeDialogApply": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelResizeDialogApply:::Apply))",
    "labelSelectRow": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelSelectRow:::Select Row))",
    "labelSelectAllRows": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.labelSelectAllRows:::Select All Rows))",
    ...
    "tooltipRequired": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTable.tooltipRequired:::Required))",
    "tooltipSeparator": " - "
  },
  "oj-ojTabs": {
  ...
  "oj-ojCheckboxset": {
    ...
    "required": {
      "hint": "",
      "messageSummary": "",
      "messageDetail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojCheckboxset.required.messageDetail:::Select a value.))"
    }
  },
  "oj-ojRadioset": {
    "readonlyNoValue": "",
    "required": {
      "hint": "",
      "messageSummary": "",
      "messageDetail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRadioset.required.messageDetail:::Select a value.))"
    }
  },
  "oj-ojSelect": {
    "required": {
      "hint": "",
      "messageSummary": "",
      "messageDetail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelect.required.messageDetail:::Select a value.))"
    },
    "searchField": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelect.searchField:::{label} search))",
    "noMatchesFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelect.noMatchesFound:::No matches found))",
    "noMoreResults": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelect.noMoreResults:::No more results))",
  ...
  "oj-ojCombobox": {
    ...
    "noMoreResults": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojCombobox.noMoreResults:::No more results))",
    "oneMatchesFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojCombobox.oneMatchesFound:::One match found))",
    "moreMatchesFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojCombobox.moreMatchesFound:::{num} matches found))",
  ...
  "oj-ojSelectSingle": {
    "required": {
      "hint": "",
      "messageSummary": "",
      "messageDetail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.required.messageDetail:::Select a value.))"
    },
    "noMatchesFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.noMatchesFound:::No matches found))",
    "oneMatchFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.oneMatchFound:::One match found))",
    "multipleMatchesFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.multipleMatchesFound:::{num} matches found))",
    "nOrMoreMatchesFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.nOrMoreMatchesFound:::{num} or more matches found))",
    "cancel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.cancel:::Cancel))",
    "labelAccOpenDropdown": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.labelAccOpenDropdown:::expand))",
    "labelAccClearValue": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.labelAccClearValue:::clear value))",
    "noResultsLine1": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.noResultsLine1:::No results found))",
    "noResultsLine2": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSelectSingle.noResultsLine2:::We can't find anything matching your search.))"
  },
  "oj-ojInputSearch2": {
    "cancel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputSearch2.cancel:::Cancel))",
    "noSuggestionsFound": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojInputSearch2.noSuggestionsFound:::No suggestions found))"
  },
  "oj-ojInputSearch": {
    "required": {
      "hint": "",
  ...
  "oj-ojTreeView": {
    "treeViewSelectorAria": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTreeView.treeViewSelectorAria:::TreeView Selector {rowKey}))",
    "retrievingDataAria": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTreeView.retrievingDataAria:::Retrieving data for node: {nodeText}))",
    "receivedDataAria": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTreeView.receivedDataAria:::Received data for node: {nodeText}))"
  },
  "oj-ojTree": {
  ...
  "oj-ojPagingControl": {
    ...
    "labelAccPageNumber": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.labelAccPageNumber:::Page {pageNum} content loaded))",
    ...
    "fullMsgItemRange": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.fullMsgItemRange:::{pageFrom}-{pageTo} of {pageMax} items))",
    "fullMsgItemRangeAtLeast": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.fullMsgItemRangeAtLeast:::{pageFrom}-{pageTo} of at least {pageMax} items))",
    "fullMsgItemRangeApprox": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.fullMsgItemRangeApprox:::{pageFrom}-{pageTo} of approx {pageMax} items))",
    "msgItemRangeNoTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.msgItemRangeNoTotal:::{pageFrom}-{pageTo} items))",
    "fullMsgItem": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.fullMsgItem:::{pageTo} of {pageMax} items))",
    "fullMsgItemAtLeast": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.fullMsgItemAtLeast:::{pageTo} of at least {pageMax} items))",
    "fullMsgItemApprox": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.fullMsgItemApprox:::{pageTo} of approx {pageMax} items))",
    "msgItemNoTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojPagingControl.msgItemNoTotal:::{pageTo} items))",
  ...
  "oj-panel": {
    ...
    "labelAccFlipForward": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-panel.labelAccFlipForward:::Flip forward))",
    "labelAccFlipBack": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-panel.labelAccFlipBack:::Flip back))",
    "tipDragToReorder": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-panel.tipDragToReorder:::Drag to reorder))",
    "labelAccDragToReorder": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-panel.labelAccDragToReorder:::Drag to reorder, context menu available))"
  },
  "oj-ojChart": {
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.accessibleContainsControls:::Contains Controls))",
    "labelCountWithTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.labelCountWithTotal:::{0} of {1}))",
    "stateCollapsed": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateCollapsed:::Collapsed))",
    "stateExpanded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateExpanded:::Expanded))",
    "stateIsolated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateIsolated:::Isolated))",
    "stateMaximized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateMaximized:::Maximized))",
    "stateMinimized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateMinimized:::Minimized))",
    ...
    "labelDataLabel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.labelDataLabel:::Label))",
    ...
    "labelQ1": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.labelQ1:::Q1))",
    "labelQ2": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.labelQ2:::Q2))",
    "labelQ3": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.labelQ3:::Q3))",
    ...
    "stateLoading": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateLoading:::Loading))",
    "stateLoaded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojChart.stateLoaded:::Loaded))",
  ...
  "oj-ojGantt": {
    ...
    "labelLevel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelLevel:::Level))",
    ...
    "labelDowntimeStart": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelDowntimeStart:::Downtime Start))",
    "labelDowntimeEnd": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelDowntimeEnd:::Downtime End))",
    "labelOvertimeStart": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelOvertimeStart:::Overtime Start))",
    "labelOvertimeEnd": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelOvertimeEnd:::Overtime End))",
    "labelAttribute": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelAttribute:::Attribute))",
    ...
    "labelResizeBy": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.labelResizeBy:::Resize By))",
    "taskMoveInitiated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskMoveInitiated:::Task move initiated))",
    "rowAxisLabel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.rowAxisLabel:::Row labels))",
    "taskResizeEndInitiated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeEndInitiated:::Task resize end initiated))",
    "taskResizeStartInitiated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeStartInitiated:::Task resize start initiated))",
    ...
    "taskResizeSelectionInfo": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeSelectionInfo:::{0} others selected))",
    ...
    "taskResizeInitiatedInstruction": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeInitiatedInstruction:::Use the arrow keys to resize))",
    "taskMoveFinalized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskMoveFinalized:::Task move finalized))",
    "taskResizeFinalized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeFinalized:::Task resize finalized))",
    "taskMoveCancelled": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskMoveCancelled:::Task move cancelled))",
    "taskResizeCancelled": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeCancelled:::Task resize cancelled))",
    "taskResizeStartHandle": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeStartHandle:::Task resize start handle))",
    "taskResizeEndHandle": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojGantt.taskResizeEndHandle:::Task resize end handle))"
  },
  "oj-ojLegend": {
    "componentName": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.componentName:::Legend))",
    "tooltipExpand": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.tooltipExpand:::Expand))",
    "tooltipCollapse": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.tooltipCollapse:::Collapse))",
    "labelInvalidData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.labelInvalidData:::Invalid data))",
    "labelNoData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.labelNoData:::No data to display))",
    "labelClearSelection": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.labelClearSelection:::Clear Selection))",
    "stateSelected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.stateSelected:::Selected))",
    "stateUnselected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.stateUnselected:::Unselected))",
    "stateMaximized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.stateMaximized:::Maximized))",
    "stateMinimized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.stateMinimized:::Minimized))",
    "stateIsolated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.stateIsolated:::Isolated))",
    "labelCountWithTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.labelCountWithTotal:::{0} of {1}))",
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojLegend.accessibleContainsControls:::Contains Controls))"
  },
  "oj-ojNBox": {
    ...
    "componentName": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNBox.componentName:::{0} Box))"
  },
  "oj-ojPictoChart": {
  ...
  "oj-ojSunburst": {
    ...
    "stateLoading": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSunburst.stateLoading:::Loading))",
    "stateLoaded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSunburst.stateLoaded:::Loaded))",
  ...
  "oj-ojTagCloud": {
    ...
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.accessibleContainsControls:::Contains Controls))",
    "labelCountWithTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.labelCountWithTotal:::{0} of {1}))",
    "labelInvalidData": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.labelInvalidData:::Invalid data))",
    "stateCollapsed": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateCollapsed:::Collapsed))",
    "stateDrillable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateDrillable:::Drillable))",
    "stateExpanded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateExpanded:::Expanded))",
    "stateIsolated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateIsolated:::Isolated))",
    "stateHidden": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateHidden:::Hidden))",
    "stateMaximized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateMaximized:::Maximized))",
    "stateMinimized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateMinimized:::Minimized))",
    "stateVisible": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTagCloud.stateVisible:::Visible))"
  },
  "oj-ojThematicMap": {
    "componentName": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojThematicMap.componentName:::Thematic Map))",
    "areasRegion": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojThematicMap.areasRegion:::Areas))",
    "linksRegion": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojThematicMap.linksRegion:::Links))",
    "markersRegion": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojThematicMap.markersRegion:::Markers))"
  },
  "oj-ojTimeAxis": {
  ...
  "oj-ojTimeline": {
    ...
    "stateMinimized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateMinimized:::Minimized))",
    "stateMaximized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateMaximized:::Maximized))",
    "stateIsolated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateIsolated:::Isolated))",
    "stateHidden": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateHidden:::Hidden))",
    "stateExpanded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateExpanded:::Expanded))",
    "stateVisible": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateVisible:::Visible))",
    "stateDrillable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateDrillable:::Drillable))",
    "stateCollapsed": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.stateCollapsed:::Collapsed))",
    "labelCountWithTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelCountWithTotal:::{0} of {1}))",
    ...
    "labelStart": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelStart:::Start))",
    "labelEnd": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelEnd:::End))",
    "labelAccNavNextPage": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelAccNavNextPage:::Next Page))",
    "labelAccNavPreviousPage": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelAccNavPreviousPage:::Previous Page))",
    "tipArrowNextPage": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.tipArrowNextPage:::Next))",
    "tipArrowPreviousPage": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.tipArrowPreviousPage:::Previous))",
    "navArrowDisabledState": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.navArrowDisabledState:::Disabled))",
    "labelDate": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelDate:::Date))",
    "labelTitle": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelTitle:::Title))",
    "labelDescription": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelDescription:::Description))",
    "labelMoveBy": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelMoveBy:::Move By))",
    "labelResizeBy": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.labelResizeBy:::Resize By))",
    "itemMoveInitiated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemMoveInitiated:::Event move initiated))",
    "itemResizeEndInitiated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeEndInitiated:::Event resize end initiated))",
    "itemResizeStartInitiated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeStartInitiated:::Event resize start initiated))",
    "itemMoveSelectionInfo": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemMoveSelectionInfo:::{0} others selected))",
    "itemResizeSelectionInfo": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeSelectionInfo:::{0} others selected))",
    "itemMoveInitiatedInstruction": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemMoveInitiatedInstruction:::Use the arrow keys to move))",
    "itemResizeInitiatedInstruction": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeInitiatedInstruction:::Use the arrow keys to resize))",
    "itemMoveFinalized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemMoveFinalized:::Event move finalized))",
    "itemResizeFinalized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeFinalized:::Event resize finalized))",
    "itemMoveCancelled": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemMoveCancelled:::Event move cancelled))",
    "itemResizeCancelled": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeCancelled:::Event resize cancelled))",
    "itemResizeStartHandle": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeStartHandle:::Event resize start handle))",
    "itemResizeEndHandle": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTimeline.itemResizeEndHandle:::Event resize end handle))"
  },
  "oj-ojTreemap": {
    ...
    "stateLoading": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTreemap.stateLoading:::Loading))",
    "stateLoaded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTreemap.stateLoaded:::Loaded))",
  ...
  "oj-dvtBaseComponent": {
    ...
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-dvtBaseComponent.accessibleContainsControls:::Contains Controls))"
  },
  "oj-ojRatingGauge": {
    "labelClearSelection": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.labelClearSelection:::Clear Selection))",
    "stateSelected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateSelected:::Selected))",
    "stateUnselected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateUnselected:::Unselected))",
    "stateMaximized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateMaximized:::Maximized))",
    "stateMinimized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateMinimized:::Minimized))",
    "stateExpanded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateExpanded:::Expanded))",
    "stateCollapsed": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateCollapsed:::Collapsed))",
    "stateIsolated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateIsolated:::Isolated))",
    "stateHidden": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateHidden:::Hidden))",
    "stateVisible": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateVisible:::Visible))",
    "stateDrillable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.stateDrillable:::Drillable))",
    "labelCountWithTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.labelCountWithTotal:::{0} of {1}))",
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRatingGauge.accessibleContainsControls:::Contains Controls))"
  },
  "oj-ojStatusMeterGauge": {
    "labelClearSelection": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.labelClearSelection:::Clear Selection))",
    "stateSelected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateSelected:::Selected))",
    "stateUnselected": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateUnselected:::Unselected))",
    "stateMaximized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateMaximized:::Maximized))",
    "stateMinimized": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateMinimized:::Minimized))",
    "stateExpanded": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateExpanded:::Expanded))",
    "stateCollapsed": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateCollapsed:::Collapsed))",
    "stateIsolated": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateIsolated:::Isolated))",
    "stateHidden": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateHidden:::Hidden))",
    "stateVisible": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateVisible:::Visible))",
    "stateDrillable": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.stateDrillable:::Drillable))",
    "labelCountWithTotal": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.labelCountWithTotal:::{0} of {1}))",
    "accessibleContainsControls": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojStatusMeterGauge.accessibleContainsControls:::Contains Controls))"
  },
  "oj-ojNavigationList": {
    ...
    "msgNoData": "",
    "overflowItemLabel": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNavigationList.overflowItemLabel:::More Tabs))",
    ...
    "accessibleExpandCollapseInstructionText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNavigationList.accessibleExpandCollapseInstructionText:::Use arrow keys to expand and collapse.))",
    "labelActions": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNavigationList.labelActions:::Actions))",
    "labelMoveLeft": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNavigationList.labelMoveLeft:::Move Left))",
    "labelMoveRight": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNavigationList.labelMoveRight:::Move Right))",
    "labelContextMenu": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojNavigationList.labelContextMenu:::has context menu))"
  },
  "oj-ojSlider": {
    ...
    "startEnd": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSlider.startEnd:::value.start must not be greater than value.end))",
    ...
    "lowerValueThumb": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSlider.lowerValueThumb:::lower value thumb))",
    "higherValueThumb": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojSlider.higherValueThumb:::higher value thumb))"
  },
  "oj-ojDialog": {
  ...
  "oj-ojRefresher": {
    "ariaRefreshLink": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRefresher.ariaRefreshLink:::Activate link to refresh content))",
    "ariaRefreshingLink": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRefresher.ariaRefreshingLink:::Refreshing content))",
    "ariaRefreshCompleteLink": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojRefresher.ariaRefreshCompleteLink:::Refresh complete))"
  },
  "oj-ojSwipeActions": {
  ...
  "oj-ojMenu": {
    ...
    "ariaFocusSkipLink": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMenu.ariaFocusSkipLink:::Focus is within the menu, double tap or swipe to move focus to the first menu item.))"
  },
  "oj-ojColorSpectrum": {
  ...
  "oj-ojFilePicker": {
    ...
    "singleFileUploadError": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.singleFileUploadError:::Upload one file at a time.))",
    "singleFileTypeUploadError": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.singleFileTypeUploadError:::You can't upload files of type {fileType}.))",
    "multipleFileTypeUploadError": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.multipleFileTypeUploadError:::You can't upload files of type: {fileTypes}.))",
    "dropzonePrimaryText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.dropzonePrimaryText:::Drag and Drop))",
    "secondaryDropzoneText": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.secondaryDropzoneText:::Select a file or drop one here.))",
    "secondaryDropzoneTextMultiple": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.secondaryDropzoneTextMultiple:::Select or drop files here.))",
    "unknownFileType": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojFilePicker.unknownFileType:::unknown))"
  },
  "oj-ojProgressbar": {
  ...
  "oj-ojMessage": {
    ...
    "categories": {
      "error": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessage.categories.error:::Error))",
      "warning": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessage.categories.warning:::Warning))",
      "info": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessage.categories.info:::Information))",
      "confirmation": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessage.categories.confirmation:::Confirmation))",
      "none": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessage.categories.none:::None))"
    }
  },
  "oj-ojMessages": {
    ...
    "ariaLiveRegion": {
      ...
      "navigationToTouch": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessages.ariaLiveRegion.navigationToTouch:::Messages region has new messages.))",
      "navigationToKeyboard": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessages.ariaLiveRegion.navigationToKeyboard:::Messages region has new messages. Press F6 to navigate.))",
      "newMessage": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessages.ariaLiveRegion.newMessage:::Message category {category}. {summary}. {detail}.))",
      "noDetail": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessages.ariaLiveRegion.noDetail:::Detail is not available))"
    }
  },
  "oj-ojMessageBanner": {
    "close": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.close:::Close))",
    "navigationFromMessagesRegion": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.navigationFromMessagesRegion:::Entering messages region. Press F6 to navigate back to prior focused element.))",
    "navigationToMessagesRegion": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.navigationToMessagesRegion:::Messages region has new messages. Press F6 to navigate.))",
    "navigationToTouch": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.navigationToTouch:::Messages region has new messages.))",
    "error": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.error:::Error))",
    "warning": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.warning:::Warning))",
    "info": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.info:::Information))",
    "confirmation": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojMessageBanner.confirmation:::Confirmation))"
  },
  "oj-ojConveyorBelt": {
    "tipArrowNext": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojConveyorBelt.tipArrowNext:::Next))",
    "tipArrowPrevious": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojConveyorBelt.tipArrowPrevious:::Previous))"
  },
  "oj-ojTrain": {
    "stepInfo": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepInfo:::Step {index} out of {count}.))",
    "stepStatus": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepStatus:::Status: {status}.))",
    "stepCurrent": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepCurrent:::Current))",
    "stepVisited": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepVisited:::Visited))",
    "stepNotVisited": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepNotVisited:::Not visited))",
    "stepDisabled": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepDisabled:::Disabled))",
    "stepMessageType": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepMessageType:::Message type: {messageType}.))",
    "stepMessageConfirmation": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepMessageConfirmation:::Confirmed))",
    "stepMessageInfo": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepMessageInfo:::Info))",
    "stepMessageWarning": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepMessageWarning:::Warning))",
    "stepMessageError": "((jet/rt/src/main/resources/nls/en/ojtranslations.js:::oj-ojTrain.stepMessageError:::Error))"
  }
};
