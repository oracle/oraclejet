 ...
 */
DataCollectionUtils.WARN_DUPLICATE_KEYS_DETAIL = DataProviderUtils.WARN_DUPLICATE_KEYS_DETAIL;
...
DataCollectionUtils.getAddEventKeysResult = function (initialKeys, addEventDetail, isLoadAll) {
  return DataProviderUtils.getAddEventKeysResult(initialKeys, addEventDetail, isLoadAll);
};
/**
 * @private
 */
...
/**
 * Helper function which returns true if the browser is Edge Chromium
 * @private
 */
DataCollectionUtils.isEdgeChromium = function () {
  return oj.AgentUtils.getAgentInfo().browser === oj.AgentUtils.BROWSER.EDGE_CHROMIUM;
};
...
const isEdgeChromium = DataCollectionUtils.isEdgeChromium;
...
export { CHECKVIEWPORT_THRESHOLD, KEYBOARD_KEYS, WARN_DUPLICATE_KEYS_DETAIL, applyMergedInlineStyles, applyRendererContent, applyStyleObj, areKeySetsEqual, calculateOffsetTop, containsKey, convertStringToStyleObj, disableAllFocusableElements, disableDefaultBrowserStyling, disableElement, enableAllFocusableElements, getActionableElementsInNode, getAddEventKeysResult, getBrowserVersion, getDefaultScrollBarWidth, getEventDetail, getFocusableElementsInNode, getLogicalChildPopup, getNoJQFocusHandlers, getScrollEventElement, handleActionablePrevTab, handleActionableTab, isAndroid, isArrowDownKeyEvent, isArrowLeftKeyEvent, isArrowRightKeyEvent, isArrowUpKeyEvent, isBlink, isChrome, isClickthroughDisabled, isContextMenuKeyEvent, isEdge, isEdgeChromium, isElementIntersectingScrollerBounds, isElementOrAncestorFocusable, isEndKeyEvent, isEnterKeyEvent, isEscapeKeyEvent, isEventClickthroughDisabled, isF2KeyEvent, isFetchAborted, isFirefox, isFromDefaultSelector, isHomeKeyEvent, isIE, isIos, isIterateAfterDoneNotAllowed, isLetterAKeyEvent, isMac, isMetaKeyEvent, isMobileTouchDevice, isNumberFiveKeyEvent, isRequestIdleCallbackSupported, isSafari, isSpaceBarKeyEvent, isTabKeyEvent, isWebkit, isWindows };
