...
(function () {
   ...
   * @ojvbmincolumns 4
   *
   * @ojoracleicon 'oj-ux-ico-color-spectrum'
  ...
  oj.__registerWidget('oj.ojColorSpectrum', $.oj.editableValue, {
    ...
    _AfterCreate: function () {
      ...
      if (label) {
        ...
        if (!labelId) {
          warn(
            'JET Color Spectrum: The label for this component needs an id in order ' +
              'to be accessible'
          );
        } else {
    ...
    _setSpectrumMask: function () {
      ...
      var grad =
        ' -___-linear-gradient(top, hsl(0, 0%, 100%) 0%, hsla(0, 0%, 100%, 0) 50%, hsla(0, 0%, 0%, 0) 50%, hsl(0, 0%, 0%) 100%),' +
    ...
    _getSatLumSpectrumPosition: function (sat, lum) {
      ...
      var lumPos =
        this._spectrumHeight - Math.min((lum / 100) * this._spectrumHeight, this._spectrumHeight);
    ...
    _setup: function () {
      ...
      this._alphaBgUrl = window
        .getComputedStyle(fakeDiv, null)
    ...
    _initSliders: function () {
      ...
      var grad =
        'linear-gradient(0deg, #ff0000 0%, #ffff00 17%, #00ff00 33%, #00ffff 50%, #0000ff 67%, #ff00ff 83%, #ff0000 100%)';
    ...
    _initData: function () {
      ...
      this._markup = (function () {
        return [
          ...
          '</div>',
          "<div class='oj-colorspectrum-thumb-description oj-helper-hidden-accessible'>" +
            thumbDesc +
            '</div>',
