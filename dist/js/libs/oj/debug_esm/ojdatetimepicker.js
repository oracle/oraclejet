...
oj.__registerWidget('oj.ojInputDate', $.oj.inputBase, {
  ...
  _InitBase: function () {
    ...
    this._isMobile = getDeviceRenderMode() === 'phone';
  ...
  _selectDay: function (month, year, td, event) {
    ...
    let updatedValue;
    const converterUtils = IntlConverterUtils;
...
oj.__registerWidget('oj.ojInputTime', $.oj.inputBase, {
  ...
  _attachClearIcon: function () {
    ...
    let isMobile = getDeviceRenderMode() === 'phone';
  ...
  _setOption: function (key, value, flags) {
    ...
    if (this._timePicker) {
      ...
      if (key in timeInvoker) {
        ...
        var newConverter =
          IntlConverterUtils.getConverterInstance(value) || this._GetDefaultConverter();
