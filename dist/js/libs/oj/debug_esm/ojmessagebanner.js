...
let MessageBanner = class MessageBanner extends Component {
    ...
    constructor(props) {
        ...
        this._renderCloseButton = (title, onAction) => {
            return (jsxs("oj-button", { class: "oj-button-sm", display: "icons", chroming: "borderless", title: title, onojAction: onAction, children: [jsx("span", { slot: "startIcon", class: "oj-fwk-icon oj-fwk-icon-cross" }), jsx("span", { children: title })] }));
        };
    ...
    render(props) {
        ...
        const nullTreatedDetailTemplateValue = typeof detailTemplateValue === 'function'
            ...
            : detailTemplateValue;
        return (jsx(Root, { ref: this._rootRef, children: jsx(MessagesContext.Provider, { value: messagesContext, children: jsx(this.WrapperMessagesContainer, { addBusyState: this._addBusyState, data: data, type: type, closeButtonRenderer: this._renderCloseButton, detailRendererKey: nullTreatedDetailTemplateValue, renderers: messageTemplates, onClose: this._handleCloseMessage, translations: {
