...
AbstractLovBase.prototype._fetchFromDataProvider = function (term, initial) {
  ...
  var retPromise = new Promise(function (resolve, reject) {
    ...
    var renderPromise = this._lovDropdown.renderResults(term, filterCriteria,
      this._isValueForPlaceholderFunc(this._value) ? null : this._value, initial);
...
const LovUtils = {
  ...
  isDataProvider: function (data) {
    return (data && DataProviderFeatureChecker) ?
      DataProviderFeatureChecker.isDataProvider(data) : false;
  },

  // LovUtils
  isTreeDataProvider: function (data) {
    return (data && DataProviderFeatureChecker) ?
      DataProviderFeatureChecker.isTreeDataProvider(data) : false;
  }
};
...
LovMainField.prototype._createInnerDom = function (options) {
  ...
  textFieldContainer.setAttribute('class',
...
oj.__registerWidget('oj.ojSelectBase', $.oj.editableValue, {
  ...
  _SetupSelectResources: function (cachedMainFieldInputElem) {
    ...
    this._initLovDropdownFunc = function (afterInitFunc) {
      ...
      if (!this._fullScreenPopup) {
        dropdownElem.addEventListener('mousedown', function () {
  ...
  _queueValueChangeDeferredCallback: function (callback) {
    ...
    var busyStateResolve = LovUtils.addBusyState(this.OuterWrapper,
    ...
    filterInputText.addEventListener('blur', function (event) {
      ...
      if (!this._fullScreenPopup) {
        ...
        var focusInFilterField = document.activeElement &&
          isAncestor(filterInputText, document.activeElement);
        if (!focusInDropdown &&
