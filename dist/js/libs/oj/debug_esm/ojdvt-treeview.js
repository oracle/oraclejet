...
DvtSunburstNode.prototype._getButtonHelper = function(resourceKey) {
  ...
  return new IconButton(context, 'outlined', {style: iconStyle, size: DvtSunburstNode._EXPAND_ICON_SIZE}, background, null, this.expandCollapse, this);
};
...
Obj.createSubclass(DvtTreeCategoryRolloverHandler, CategoryRolloverHandler, 'DvtTreeCategoryRolloverHandler');
