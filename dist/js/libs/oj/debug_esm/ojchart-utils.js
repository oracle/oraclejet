...
function getLabelFormatInfo(options) {
    ...
    let mixin = new (DataAxisInfoMixin(class {
    }))(null, axisOptions);
    ...
    if (!obj.isLog) {
        formatter = new LinearScaleAxisValueFormatter(obj.min, obj.max, obj.step, 'auto', 'on');
        ...
        for (var i = 0; i <= obj.numSteps; i++) {
            ...
            formatter = new LinearScaleAxisValueFormatter(value, value, value, 'auto', 'on');
