...
(function () {
  ...
  oj.__registerWidget('oj.ojFilmStrip', $.oj.baseComponent, {
    ...
    _destroyInternal: function _destroyInternal() {
      ...
      var elem = this.element;
      oj.DomUtils.removeResizeListener(elem[0], this._handleResizeFunc); // reset item size so it will be recalculated at the next layout
    ...
    _handleTransitionEnd: function _handleTransitionEnd() {
      ...
      if (oj.FocusUtils.containsFocus(pagesWrapper[0]) || this._nextButton && oj.FocusUtils.containsFocus(this._nextButton[0]) || this._prevButton && oj.FocusUtils.containsFocus(this._prevButton[0])) {
