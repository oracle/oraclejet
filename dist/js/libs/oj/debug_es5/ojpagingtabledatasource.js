...
oj.PagingTableDataSource.prototype.setPage = function (value, options) {
  ...
  try {
    oj.PagingTableDataSource.superclass.handleEvent.call(this, oj.PagingModel.EventType.BEFOREPAGE, {
      page: value,
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (self._pageSize > 0) {
      self.dataSource.fetch(options).then(function (result) {
        ...
        oj.PagingTableDataSource.superclass.handleEvent.call(self, oj.PagingModel.EventType.PAGE, {
