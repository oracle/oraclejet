...
define(['ojs/ojcore', 'ojs/ojconfig', 'ojs/ojtranslation', 'ojL10n!ojtranslations/nls/localeElements', 'ojs/ojlocaledata', 'ojs/ojconverterutils-i18n', 'ojs/ojlogger', 'ojs/ojconverter'], 
...
/* global OraNumberConverter:false, LocaleData:false, __ConverterUtilsI18n:false, Logger:false, Config:false, Translations:false, NumberConverter:false */
...
oj.Object.createSubclass(IntlNumberConverter, NumberConverter, 'oj.IntlNumberConverter');
/**
 * Initializes the number converter instance with the set options.
 * @param {Object=} options an object literal used to provide an optional information to
 * initialize the converter.<p>
...
IntlNumberConverter.prototype.format = function (value) {
  ...
  if (value == null || typeof value === 'string' && oj.StringUtils.trim('' + value).length === 0 || typeof value === 'number' && isNaN(value)) {
    return '';
  }
...
IntlNumberConverter.prototype.parse = function (value) {
  ...
  try {
    ...
    return this._getWrapped().parse(oj.StringUtils.trim(value), localeElements, resolvedOptions, locale);
  } catch (e) {
    converterError = this._processConverterError(e, value);
    throw converterError;
  }
...
var __ConverterNumber = {}; // eslint-disable-next-line no-undef

__ConverterNumber.NumberConverter = NumberConverter; // eslint-disable-next-line no-undef

__ConverterNumber.IntlNumberConverter = IntlNumberConverter;
...
/* global Logger:false,  __ConverterUtilsI18n:false */
