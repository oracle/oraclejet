  ...
  for (var i = 0; i < columnsCount; i++) {
    ...
    if (headerColumnCell != null) {
      ...
      if (headerColumnDiv.length > 0) {
        ...
        var headerColumnTextDiv = this._getTableElementsByClassName(headerColumnCell, Table.CSS_CLASSES._COLUMN_HEADER_TEXT_CLASS);
        ...
        if (headerColumnTextDiv.length > 0) {
          if (headerColumnDiv.clientWidth > 0 && headerColumnTextDiv[0].clientWidth + sortContainerWidth >= headerColumnDiv.clientWidth) {
            ...
            if (headerColumnTextDivWidth + sortContainerWidth >= newHeaderColumnTextDivWidth + 1) {
              headerColumnTextDiv[0].style[Table.CSS_PROP._WIDTH] = newHeaderColumnTextDivWidth - sortContainerWidth + Table.CSS_VAL._PX;
            }
          }
        }
      }
...
Table.prototype._updateSelector = function (selected) {
  ...
  var headerSelector = table.getElementsByClassName(Table.CSS_CLASSES._TABLE_HEADER_SELECTOR_CLASS)[0];
...
oj.TableDndContext.prototype._cloneTableContainer = function (tableContainer) {
  ...
  if (this.component._isDefaultSelectorEnabled()) {
    var headerSelector = this.component._getTableElementsByClassName(tableContainerClone, Table.CSS_CLASSES._TABLE_HEADER_SELECTOR_CLASS, true)[0];
