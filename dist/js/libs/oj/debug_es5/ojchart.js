...
oj.ChartDataProviderHandler.prototype._addToGroupContexts = function (itemContext, groupId, depth, count) {
...
oj.ChartDataProviderHandler.prototype._addGroupItem = function (item, groupId, groupsArray, chartGroupItems) {
  if (!groupsArray) {
    // eslint-disable-next-line no-param-reassign
    groupsArray = [];
  }
...
oj.__registerWidget('oj.ojChart', $.oj.dvtBaseComponent, {
  ...
  _ProcessTemplates: function _ProcessTemplates(dataProperty, data, templateEngine, isTreeData, parentKey, isRoot, updateChildren) {
    ...
    if (!results) {
      ...
      var chartOptions = new oj.ChartDataProviderHandler(this, templateEngine, items.values[0], dataProperty);
      results = {
        paths: ['series', 'groups'],
  ...
  _GetChildStyleClasses: function _GetChildStyleClasses() {
    ...
    styleClasses['oj-chart-data-label'] = {
      path: 'styleDefaults/dataLabelStyle',
      property: 'TEXT'
    };
