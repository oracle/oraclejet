...
oj.CubeDataGridDataSource.prototype.move = function ( // eslint-disable-next-line no-unused-vars
...
oj.CubeHeaderSet = function (axis, cube, start, count) {
  // The oj.Cube
  this._cube = cube; // The oj.CubeAxis
...
oj.DataColumnCube = function (rowset, layout, dataValues) {
  ...
  this._defaultAggregation = defAgg ? oj.DataColumnCube._getDefaultAgg(defAgg) : {
