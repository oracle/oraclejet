...
oj.CompositeTemplateRenderer.renderTemplate = function (params, element, view) {
  ...
  var bindingContext = oj.CompositeTemplateRenderer._getKoBindingContext(); // Null out the parent references since we don't want the composite View to be able to access the outside context
