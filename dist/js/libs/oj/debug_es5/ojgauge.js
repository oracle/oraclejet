...
oj.__registerWidget('oj.dvtBaseGauge', $.oj.dvtBaseComponent, {
  ...
  _ProcessStyles: function _ProcessStyles() {
    ...
    this._super(); // Transfer the threshold colors to the correct location
  ...
  _GetChildStyleClasses: function _GetChildStyleClasses() {
    ...
    styleClasses['oj-gauge-tick-label'] = {
      path: 'tickLabel/style',
      property: 'TEXT'
    };
...
oj.__registerWidget('oj.ojRatingGauge', $.oj.dvtBaseGauge, {
  ...
  _GetComponentStyleClasses: function _GetComponentStyleClasses() {
    ...
    styleClasses.push('oj-ratinggauge'); // TODO  Add style classes for rating gauge selected/hover/unselected/changed
