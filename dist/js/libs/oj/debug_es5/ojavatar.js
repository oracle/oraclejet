...
define(['exports', 'ojs/ojvcomponent'], function (exports, ojvcomponent) {
  ...
  exports.Avatar = /*#__PURE__*/function (_ojvcomponent$VCompon) {
    _inherits(Avatar, _ojvcomponent$VCompon);
    ...
    _createClass(Avatar, [{
      ...
      value: function render() {
        ...
        if (props.src) {
          innerContent = ojvcomponent.h("div", {
  ...
  exports.Avatar.metadata = {
    ...
    "properties": {
      "background": {
        "type": "string",
        "enumValues": ["neutral", "red", "orange", "forest", "green", "teal", "mauve", "purple"],
        "value": "neutral"
      },
      "initials": {
        "type": "string|null",
  ...
  exports.Avatar = __decorate([ojvcomponent.customElement('oj-avatar')], exports.Avatar);
