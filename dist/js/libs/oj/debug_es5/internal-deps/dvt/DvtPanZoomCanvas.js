...
(function (dvt) {
  ...
  dvt.PanZoomComponent.prototype.Init = function (context, callback, callbackObj) {
    dvt.PanZoomComponent.superclass.Init.call(this, context, callback, callbackObj); // IE11 does not support vector-effects=non-scaling-stroke so we still need to set stroke width based on zoom
  ...
  dvt.PanZoomComponent.prototype.HandlePanEvent = function (event) {// subclasses should override
  };
  /**
  ...
  dvt.PanZoomComponent.prototype.HandleZoomEvent = function (event) {// subclasses should override
  };
  /**
  ...
  dvt.PanZoomComponent.prototype.PreRender = function () {// subclasses should override
  };
  /**
  ...
  dvt.PanZoomCanvasEventManager.prototype._handleMomentumStartTimer = function () {//do nothing
  };
  /**
  ...
  dvt.PanZoomCanvasEventManager.prototype.HandleImmediateTouchStartInternal = function (event) {
    if (this._callbackObj.isZoomingEnabled()) this.TouchManager.processAssociatedTouchAttempt(event, dvt.PanZoomCanvasEventManager._ZOOM_TOUCH_KEY, this.ZoomStartTouch, this);
    if (this._callbackObj.isPanningEnabled()) this.TouchManager.processAssociatedTouchAttempt(event, dvt.PanZoomCanvasEventManager._PAN_TOUCH_KEY, this.PanStartTouch, this);
  };
  /**
   * @override
   */
  ...
  dvt.PanZoomCanvasEventManager.prototype.HandleImmediateTouchMoveInternal = function (event) {
    if (this._callbackObj.isZoomingEnabled()) this.TouchManager.processAssociatedTouchMove(event, dvt.PanZoomCanvasEventManager._ZOOM_TOUCH_KEY);
    if (this._callbackObj.isPanningEnabled()) this.TouchManager.processAssociatedTouchMove(event, dvt.PanZoomCanvasEventManager._PAN_TOUCH_KEY); //  Only prevent default browser behavior if panning or zooming is enabled
  ...
  dvt.PanZoomCanvasEventManager.prototype.HandleImmediateTouchEndInternal = function (event) {
    if (this._callbackObj.isZoomingEnabled()) this.TouchManager.processAssociatedTouchEnd(event, dvt.PanZoomCanvasEventManager._ZOOM_TOUCH_KEY);
    if (this._callbackObj.isPanningEnabled()) this.TouchManager.processAssociatedTouchEnd(event, dvt.PanZoomCanvasEventManager._PAN_TOUCH_KEY);
  };
  /**
