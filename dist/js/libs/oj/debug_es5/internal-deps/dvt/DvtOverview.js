...
(function (dvt) {
  ...
  dvt.Overview.prototype.Init = function (context, callback, callbackObj) {
    dvt.Overview.superclass.Init.call(this, context); // Create the defaults object
  ...
  dvt.Overview.prototype.getMinimumWindowWidth = function () {
    ...
    } else return dvt.Overview.MIN_WINDOW_SIZE;
  ...
  dvt.Overview.prototype.getHandleStart = function () {
    if (dvt.OverviewUtils.supportsTouch()) return this.getHandleSize() / 2;else return 0;
  }; // return the size of the resize handle, which is wider on touch devices


  dvt.Overview.prototype.getHandleSize = function () {
    if (dvt.OverviewUtils.supportsTouch()) return 30;else return 10;
  };
  ...
  dvt.Overview.prototype.getTimeAxisWidth = function () {
    ...
    if (this._timeAxisWidth == null) {
      ...
      if (!isNaN(width) && width < this.Width) this._timeAxisWidth = width;else this._timeAxisWidth = dvt.Overview.DEFAULT_VERTICAL_TIMEAXIS_SIZE;
    }
  ...
  dvt.Overview.prototype.getTimeAxisHeight = function () {
    ...
    if (this._timeAxisHeight == null) {
      ...
      if (!isNaN(height) && height < this.Height) this._timeAxisHeight = height;else this._timeAxisHeight = dvt.Overview.DEFAULT_HORIZONTAL_TIMEAXIS_SIZE;
    }
