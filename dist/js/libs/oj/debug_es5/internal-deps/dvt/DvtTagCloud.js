...
(function (dvt) {
  ...
  dvt.Obj.createSubclass(dvt.TagCloud, dvt.BaseComponent); // TODO ADD TESTS: AUTOMATION & DVT-SHARED-JS
  ...
  var DvtTagCloudObjPeer = function DvtTagCloudObjPeer(tagCloud, displayable, data) {
  ...
  DvtTagCloudRenderer._renderEmptyText = function (tagCloud, container, availSpace) {
    ...
    dvt.TextUtils.renderEmptyText(container, emptyTextStr, new dvt.Rectangle(availSpace.x, availSpace.y, availSpace.w, availSpace.h), tagCloud.EventManager, options['_statusMessageStyle']);
  };
  /**
