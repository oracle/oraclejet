...
oj.Object.createSubclass(IntlDateTimeConverter, DateTimeConverter, 'oj.IntlDateTimeConverter');
...
IntlDateTimeConverter.prototype.format = function (value) {
  ...
  if (value == null || typeof value === 'string' && oj.StringUtils.trim('' + value).length === 0) {
    return '';
  }
...
var __ConverterDateTime = {}; // eslint-disable-next-line no-undef

__ConverterDateTime.DateTimeConverter = DateTimeConverter; // eslint-disable-next-line no-undef
  ...
  function _init() {
    return {
      ...
      calculateWeek: function calculateWeek(date) {
        ...
        var time;
        var checkDate = new Date(d.getTime()); // Find Thursday of this week starting on Monday
