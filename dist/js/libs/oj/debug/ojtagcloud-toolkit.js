...
define(['exports', 'ojs/ojdvt-toolkit'], function (exports, dvt) { 'use strict';
  ...
  class DvtTagCloudObjPeer {
    ...
    getDatatip () {
      ...
      return dvt.Displayable.resolveShortDesc(this.getShortDesc(), () => DvtTagCloudObjPeer.getShortDescContext(this));
   ...
   /**
    ...
    getAriaLabel () {
      ...
      return dvt.Displayable.generateAriaLabel(this.getShortDesc(), states, () => DvtTagCloudObjPeer.getShortDescContext(this));
    }
  ...
  class DvtTagCloudItem extends  dvt.BackgroundOutputText {
    ...
    animateDelete (handler) {
      handler.add(new dvt.AnimFadeOut(this.getCtx(), this, this.getAnimDur(this._tagCloud)), this.ANIM_DELETE_PRIORITY);
    }
    ...
    animateInsert (handler) {
      this.setAlpha(0);
      handler.add(new dvt.AnimFadeIn(this.getCtx(), this, this.getAnimDur(this._tagCloud)), this.ANIM_INSERT_PRIORITY);
    }
