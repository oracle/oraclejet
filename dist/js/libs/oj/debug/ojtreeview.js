 ...
 * @ignore
 */
define(['require', 'ojs/ojcore-base', 'jquery', 'ojs/ojcontext', 'ojs/ojthemeutils', 'ojs/ojcomponentcore', 'ojs/ojanimation', 'ojs/ojdomutils', 'ojs/ojlogger', 'ojs/ojconfig', 'ojs/ojkeyset', 'ojs/ojselector', 'ojdnd', 'ojs/ojcustomelement-utils', 'ojs/ojdatacollection-common', 'ojs/ojtranslation', 'ojs/ojset'], function (require, oj, $, Context, ThemeUtils, ojcomponentcore, ojanimation, DomUtils, Logger, ojconfig, ojkeyset, ojselector, ojdnd, ojcustomelementUtils, DataCollectionUtils, Translations, OjSet) { 'use strict';
  ...
  class TreeviewSelectionManager {
    ...
    computeSelection(
      currentKeySet,
      previousKeySet = new ojkeyset.KeySetImpl(),
  ...
  (function () {
    oj.__registerWidget('oj.ojTreeView', $.oj.baseComponent, {
      ...
      _handleKeyDown: function (event) {
        ...
        } else if (DataCollectionUtils.isSpaceBarKeyEvent(eventKey)) {
          // SPACE
          event.preventDefault(); // prevent scrolling the page
