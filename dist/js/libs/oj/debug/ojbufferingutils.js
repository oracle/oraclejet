 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojdataprovider', 'ojs/ojmap'], function (exports, oj, ojdataprovider, ojMap) { 'use strict';
    ...
    class BufferingDataProviderUtils {
        ...
        static async fetchFromOffset(params, dataProvider, editBuffer, keyCache, lastFetchByOffsetParams, ignoreAfterTransaction) {
            ...
            const callback = async (resolve) => {
                ...
                if (!ojdataprovider.DataProviderUtils.isSameFetchParameters(lastFetchByOffsetParams, params, [
                    'sortCriteria',
                    'filterCriterion'
                ])) {
                    keyCache.reset();
        ...
        static setItemStatus(editItem, newStatus, generatedKeyMap, editBuffer, error, newKey) {
            if (editItem) {
                ...
                if (status === 'mutated') {
                    ...
                    return { editBuffer, mutationEvent: new ojdataprovider.DataProviderMutationEvent(detail) };
                }
