 ...
 * @ignore
 */
define(['exports', 'ojs/ojlogger', 'ojs/ojconfig', 'ojs/ojlocaledata', 'ojs/ojconverterutils-i18n', 'ojs/ojtranslation', 'ojs/ojcore-base', 'ojs/ojcalendarutils', 'ojs/ojoratimezone', 'ojs/ojconverter-preferences'], function (exports, Logger, ojconfig, LocaleData, __ConverterUtilsI18n, Translations, oj, ojcalendarutils, ojoratimezone, ojconverterPreferences) { 'use strict';
    ...
    class NativeDateTimeConverter {
        ...
        getTimeZoneOffset(isoString, timeZone, formatted) {
            ...
            if (this.inputTimeZone) {
                const localeElements = LocaleData.__getBundle();
                const oraTz = ojoratimezone.OraTimeZone.getInstance();
