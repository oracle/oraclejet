...
var __oj_list_view_metadata = 
{
  ...
  const _ojListView = _ListViewUtils.clazz(
    ...
    /** @lends oj._ojListView.prototype */ {
       ...
       */
      _isRedwood: function () {
        return ThemeUtils.parseJSONFromFontFamily('oj-theme-json').behavior === 'redwood';
      },
      ...
      _isTextSelectionEnabled: function () {
        return (
          this.ShouldUseGridRole() && this._isRedwood() && !DataCollectionUtils.isMobileTouchDevice()
        );
      },
        ...
        if (options != null) {
          ...
          if (scroller != null) {
            ...
            if (scroller != null && !scroller.contains(this.getListContainer()[0])) {
              Logger.warn('the specified scroller must be an ancestor of the component');
              scroller = null;
            }
          }
        }
