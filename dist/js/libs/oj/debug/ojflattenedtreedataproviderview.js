...
define(['ojs/ojcore-base', 'ojs/ojset', 'ojs/ojeventtarget', 'ojs/ojobservable', 'ojs/ojmap', 'ojs/ojdataprovider', 'ojs/ojkeyset'], function (oj, ojSet, ojeventtarget, ojobservable, ojMap, ojdataprovider, ojkeyset) { 'use strict';
    ...
    class FlattenedTreeDataProviderView {
                ...
                for (let i = 0; i < this._cache.length; i++) {
                    ...
                    if (keys.has(item.metadata.key)) {
                        ...
                        const refreshDetail = disregardAfterKey != null
                            ...
                            : undefined;
                        const refreshEvent = new ojdataprovider.DataProviderRefreshEvent(refreshDetail);
        ...
        fetchFirst(params) {
            const iteratorFunction = async () => {
                return await this._taskQueue.enqueue(async () => {
                    ...
                    if (!ojdataprovider.DataProviderUtils.isSameFetchParameters(this._currentCriteria, params, [
                        'sortCriteria',
                        'filterCriterion'
                    ])) {
                        this._clearCaches();
        ...
        _fetchByOffset(params) {
            ...
            if (ojdataprovider.DataProviderUtils.isSameFetchParameters(this._currentCriteria, clonedParams, [
                'sortCriteria',
                'filterCriterion'
            ])) {
