 ...
 * @since 5.0.0
 */
var ModuleElementUtils = function() {};

// Subclass from oj.Object 
oj.Object.createSubclass(ModuleElementUtils, oj.Object, "ModuleElementUtils");
...
ModuleElementUtils.createView = function(options)
{
  ...
  var returnPromise = new Promise( function(resolve, reject) {
    viewPromise.then(
      function(value){
        var viewArray = oj.__HtmlUtils.stringToNodeArray(value);
