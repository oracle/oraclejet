    ...
    _handlePanMove(xx, yy) {
      ...
      if (this._bMomentumPanning) {
        ...
        if (this._momentumStartTimer) {
          ...
          this._momentumStartTimer = new dvt.Timer(this._context, this._MOMENTUM_START_TIMER_INTERVAL, this._handleMomentumStartTimer, this, 1);
        }
    ...
    _handlePanEnd() {
      ...
      if (this._momentumStartTimer && this._momentumStartTimer.isRunning()) {
        ...
        if (!this._momentumTimer) {
          ...
          this._momentumTimer = new dvt.Timer(this._context, this._MOMENTUM_START_TIMER_INTERVAL, this._handleMomentumTimer, this);
        }
        else {
          this._momentumTimer.reset();
        }
  ...
  /**
   ...
   class PanZoomCanvas extends dvt.Container {
    ...
    FireZoomEvent(subtype, newZoom, oldZoom, animator, xx, yy, panX, panY, panAndZoom) {
      ...
      var zoomEvent = dvt.EventFactory.newZoomEvent(subtype, newZoom, oldZoom, animator, new dvt.Point(xx, yy), point, panAndZoom);
