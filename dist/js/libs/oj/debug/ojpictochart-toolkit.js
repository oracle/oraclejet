...
define(['exports', 'ojs/ojdvt-toolkit'], function (exports, dvt) { 'use strict';
  ...
  class DvtPictoChartImageMarker extends dvt.ImageMarker {
    ...
    animateUpdate (handler, oldMarker) {
      ...
      animator.addProp(dvt.Animator.TYPE_NUMBER_ARRAY, this, this._getAnimParams, this._setAnimParams, endParams);
  ...
  class DvtPictoChartItem extends dvt.Container {
    ...
    getDatatip () {
      ...
      if (this.getShortDesc() != null)
        return dvt.Displayable.resolveShortDesc(this.getShortDesc(), () => DvtPictoChartItem.getShortDescContext(this));
    ...
    getAriaLabel () {
      ...
      return dvt.Displayable.generateAriaLabel(shortDesc, states, () => DvtPictoChartItem.getShortDescContext(this));
    }
      ...
      if (animOnDisplay === 'popIn') {
        ...
        for (var k = 0; k < this._markers.length; k++) {
          ...
          if (DvtPictoChartUtils.isVertical(this)) {
            ...
            playable.getAnimator().addProp(dvt.Animator.TYPE_NUMBER, markerAnim, markerAnim.getCx, markerAnim.setCx, endState);
          }
          else {
            startState = DvtPictoChartUtils.isOriginBottom(this) ? this.Height : 0;
            endState = markerAnim.getCy();
            markerAnim.setCy(startState);
            playable.getAnimator().addProp(dvt.Animator.TYPE_NUMBER, markerAnim, markerAnim.getCy, markerAnim.setCy, endState);
          }
