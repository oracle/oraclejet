...
oj.FlattenedTreeCellSet.prototype.getData = function (indexes) {
  ...
  oj.Assert.assert(row < this.m_nodeSet.getStart() + this.m_nodeSet.getCount() &&
 ...
 * @return {undefined}
 */
oj.FlattenedTreeDataGridDataSource.prototype.fetchHeaders = function (
 ...
 * @return {undefined}
 */
oj.FlattenedTreeDataGridDataSource.prototype.fetchCells = function (
...
oj.FlattenedTreeDataGridDataSource.prototype.keys = function (indexes) {
  ...
  return new Promise(function (resolve) {
    ...
    if (rowIndex > oj.FlattenedTreeDataGridDataSource.superclass.getFetchedRange.call(this).end ||
...
oj.FlattenedTreeDataGridDataSource.prototype.indexes = function (keys) {
  ...
  return new Promise(function (resolve) {
    ...
    var rowIndex = oj.FlattenedTreeDataGridDataSource.superclass.getIndex.call(this, rowKey);
 ...
 * @return {undefined}
 */
oj.FlattenedTreeDataGridDataSource.prototype.sort = function (
 ...
 * @private
 */
oj.FlattenedTreeDataGridDataSource.prototype._handleSortSuccess = function (
  callbacks, callbackObjects
) {
  // reset state
  this.refresh();
 ...
 * @return {undefined}
 */
oj.FlattenedTreeDataGridDataSource.prototype.move = function (
 ...
 * @private
 */
oj.FlattenedTreeDataGridDataSource.prototype._handleFetchRowsSuccess = function (
  ...
  // create wrapper
  var cellSet = new oj.FlattenedTreeCellSet(rowStart, rowStart + rowCount,
 ...
 * @private
 */
oj.FlattenedTreeDataGridDataSource.prototype._handleFetchRowsError = function (
 ...
 * @private
 */
oj.FlattenedTreeDataGridDataSource.prototype._handleRowHeaderFetchSuccess = function (
  nodeSet, headerRange, callbacks, callbackObjects
) {
  // create wrapper
  var headerSet = new oj.FlattenedTreeHeaderSet(headerRange.start,
 ...
 * @protected
 */
oj.FlattenedTreeDataGridDataSource.prototype.insertRows = function (
  insertAtIndex, insertAtRowKey, nodeSet
) {
  var headerSet = null;
  if (this.m_rowHeader) {
    headerSet = new oj.FlattenedTreeHeaderSet(insertAtIndex,
                                              insertAtIndex + nodeSet.getCount(),
                                              this.m_columns, nodeSet, this.m_rowHeader);
  }
  // create a CellSet that wraps around a RowSet
  var cellSet = new oj.FlattenedTreeCellSet(insertAtIndex,
                                            insertAtIndex + nodeSet.getCount(),
...
FlattenedTreeDataGridDataSource.FlattenedTreeDataGridDataSource =
