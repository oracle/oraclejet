 ...
 * @return {Array.<oj.CubeAxis>} an array of oj.CubeAxis objects
 * @memberof oj.Cube
 * @export
 */
...
oj.Cube.prototype.pivot = function (axisFrom, levelFrom, axisTo, levelTo, type) {
  ...
  } else if (type === oj.Cube.PivotType.SWAP) {
    // Swap the elements
 ...
 * @return {Array.<oj.CubeAxisValue>} an array of oj.CubeAxisValues--all the slower-varying level axis values under which this value is grouped
 * @memberof oj.CubeAxisValue
 * @export
 */
 ...
 * @return {Array.<oj.CubeAxisValue>} an array of the children of this oj.CubeAxisValue
 * @memberof oj.CubeAxisValue
 * @export
 */
 ...
 * @class oj.CubeAxis
 * @since 1.1.0
 * @classdesc Represents an axis (a collection of levels) in a cube.  There is a set of oj.CubeAxisValues at each index within an axis,
 ...
 * every level
 * @return {Array.<oj.CubeLevel>} an ordered array of {@link oj.CubeLevel}
 * @memberof oj.CubeAxis
 * @export
 */
 ...
 * @return {Array.<oj.CubeAxisValue>} the ordered list of oj.CubeAxisValues at this index (slowest to fastest varying).
 * @memberof oj.CubeAxis
 * @export
 */
 ...
 * @export
 */
oj.CubeAxis.prototype.axis = undefined;
 ...
 * @export
 */
oj.CubeDataGridDataSource.prototype.fetchHeaders = function (
  headerRange, callbacks, callbackObjects
) {
  var cubeheaders = new oj.CubeHeaderSet(this._getAxis(headerRange.axis),
 ...
 * @export
 */
oj.CubeDataGridDataSource.prototype.move = function (
  // eslint-disable-next-line no-unused-vars
 ...
 * @export
 */
 oj.CubeLevel.prototype.attribute = undefined;
 ...
 * @export
 */
 oj.CubeLevel.prototype.axis = undefined;
...
oj.DataColumnCube = function (rowset, layout, dataValues) {
  ...
  this._defaultAggregation = (defAgg ?
                              oj.DataColumnCube._getDefaultAgg(defAgg) :
                              { aggregation: oj.CubeAggType.SUM });
 ...
 * @protected
 */
oj.DataValueAttributeCube.prototype.ProcessLevel = function (
...
var Cube = {};
Cube.Cube = oj.Cube;
Cube.CubeAggType = oj.CubeAggType;
Cube.CubeAxis = oj.CubeAxis;
Cube.CubeAxisValue = oj.CubeAxisValue;
Cube.CubeCellSet = oj.CubeCellSet;
Cube.CubeDataGridDataSource = oj.CubeDataGridDataSource;
Cube.CubeDataValue = oj.CubeDataValue;
Cube.CubeHeaderSet = oj.CubeHeaderSet;
Cube.CubeLevel = oj.CubeLevel;
Cube.DataColumnCube = oj.DataColumnCube;
Cube.DataValueAttributeCube = oj.DataValueAttributeCube;
