 ...
 * @ignore
 */
define(['exports', 'preact/hooks', 'preact', 'ojs/ojanimation', 'ojs/ojtranslation', 'ojs/ojcontext', 'ojs/ojdataproviderhandler', 'ojs/ojvcomponent', 'ojs/ojbutton'], function (exports, hooks, preact, AnimationUtils, Translations, Context, ojdataproviderhandler, ojvcomponent, ojbutton) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function MessagesManager(props) {
        ...
        return (preact.h(TransitionGroup, { elementType: preact.Fragment }, data.map((item, index) => (preact.h(Transition, { key: item.key, metadata: { index, key: item.key }, onEntering: handleEntering, onExiting: handleExiting }, children === null || children === void 0 ? void 0 : children({ index, item }))))));
    }
    /**
    ...
    function MessageBanner({ closeButtonRenderer, detailRendererKey, data, onClose, renderers, startAnimation, translations = DEFAULT_TRANSLATIONS, type = 'section' }) {
        ...
        return (preact.h("div", Object.assign({ ref: containerDivRef, class: 'oj-messagebanner', tabIndex: -1 }, handlers),
            preact.h(Flex, { direction: "column", gap: type === 'section' ? 'xs' : undefined },
                preact.h(MessagesManager, { animations: DEFAULT_ANIMATIONS, data: data, startAnimation: startAnimation, onMessageWillRemove: handleNextFocus }, ({ index, item }) => {
                    return (preact.h(Message, { messageRef: messagesRef[index], item: item, closeButtonRenderer: closeButtonRenderer, detailRenderer: getRenderer(item, detailRendererKey, renderers), index: index, key: item.key, translations: translations, type: type, onClose: handleClose }));
                }),
                preact.h(LiveRegion, { text: liveRegionText }))));
    }
    ...
    exports.MessageBanner = class MessageBanner$1 extends preact.Component {
        constructor(props) {
            ...
            this._renderCloseButton = (title, onAction) => {
                return (preact.h("oj-button", { class: 'oj-button-sm', display: 'icons', chroming: 'borderless', title: title, onojAction: onAction },
                    preact.h("span", { slot: 'startIcon', class: 'oj-fwk-icon oj-fwk-icon-cross' }),
