...
/**
   ...
   * as shown at https://oss.oracle.com/licenses/upl/
   * @ignore
   */var n;(n={properties:{value:{type:"string",value:""}},methods:{getProperty:{},refresh:{},setProperties:{},setProperty:{},getNodeBySubId:{},getSubIdByNode:{}},extension:{}}).extension._CONSTRUCTOR=i,n.extension._CONTROLS_SUBTREE_HIDDEN=!0,oj.CustomElementBridge.register("oj-switcher",{metadata:n})});
