...
/**
     ...
     * as shown at https://oss.oracle.com/licenses/upl/
     * @ignore
     */const je={banner:"oj-message-banner-b10cag1l"};function xe({onAction:e,buttonRenderer:t,title:r="Close",variant:o="banner"}){const i=t?t(r,e,o):n.h("button",{"aria-label":r,onClick:e,title:r},"X"),a=`oj-message${o}-close-icon ${je[o]}`;return n.h("div",{class:a},i)}
/**
     * @license
     * Copyright (c) %FIRST_YEAR% %CURRENT_YEAR%, Oracle and/or its affiliates.
     * The Universal Permissive License (UPL), Version 1.0
...
/**
     ...
     * as shown at https://oss.oracle.com/licenses/upl/
     * @ignore
     */const Se={base:"oj-message-base-bbznd28",banner:"oj-message-banner-b39ctpn"};function _e(e){const{detail:t}=e.data;return Ee(t)?n.h(n.Fragment,null,t):null}function Oe({item:e,renderer:t=_e,variant:r="banner"}){const o=t(e);if(null==o)return null;const i=`oj-message${r}-detail ${Se.base} ${Se[r]}`;return n.h("div",{class:i},o)}
/**
     * @license
     * Copyright (c) %FIRST_YEAR% %CURRENT_YEAR%, Oracle and/or its affiliates.
     * The Universal Permissive License (UPL), Version 1.0
...
/**
     ...
     * as shown at https://oss.oracle.com/licenses/upl/
     * @ignore
     */};function ze({severity:e,variant:t="banner",translations:r}){const o=Be[e];return n.h("div",{class:(i=[`oj-message${t}-start-icon`,"oj-message-messageStartIconStyles-mmmpf1e"],i.filter(Boolean).join(" ")),role:"presentation"},n.h(o,{class:Te[t],title:null==r?void 0:r[e]}));var i}
/**
     * @license
     * Copyright (c) %FIRST_YEAR% %CURRENT_YEAR%, Oracle and/or its affiliates.
     * The Universal Permissive License (UPL), Version 1.0
     * as shown at https://oss.oracle.com/licenses/upl/
     * @ignore
     */const Ae={base:"oj-message-base-bczmanu",banner:"oj-message-banner-bonzci6"};function De({text:e,variant:t="banner"}){const r=`oj-message${t}-summary ${Ae.base} ${Ae[t]}`;return n.h("div",{role:"heading",class:r},e)}
/**
     * @license
     * Copyright (c) %FIRST_YEAR% %CURRENT_YEAR%, Oracle and/or its affiliates.
     * The Universal Permissive License (UPL), Version 1.0
...
/**
     ...
     * as shown at https://oss.oracle.com/licenses/upl/
     * @ignore
     */const We="oj-message-base-bb5rzqk",Le="oj-message-section-s1c5gur5",qe="oj-message-header-h1k6g34i",Ye="oj-message-content-cy2ssrz";function He({children:e}){return n.h("div",{role:"presentation",class:qe},e)}function Ke({closeButtonRenderer:e,detailRenderer:r,index:o=-1,item:i,onClose:a,messageRef:s=(()=>{}),translations:l,type:c}){const{closeAffordance:u="on",severity:d="error",sound:f,summary:h,timestamp:g}=i.data,p=function(e){return z([Ee(e,"severity")&&"none"!==e&&"oj-messagebanner-"+e])}(d),m=t.useRef(null);t.useImperativeHandle(s,()=>({focus:()=>{var e;return null===(e=m.current)||void 0===e?void 0:e.focus()},contains:e=>{var t,n;return m.current===e||null!==(n=e&&(null===(t=m.current)||void 0===t?void 0:t.contains(e)))&&void 0!==n&&n}}));const v=t.useCallback(()=>{null==a||a(i)},[i,a]),y=t.useCallback(e=>{"Escape"===e.key&&"on"===u&&(null==a||a(i))},[u,i,a]);t.useEffect(()=>{Ee(f)&&Ne(f)},[]);const b=z([We,p,"section"===c&&Le]);return n.h("div",{ref:m,class:b,role:"alert","aria-atomic":"true",tabIndex:0,onKeyDown:y},n.h("div",{class:Ye},function(e){return Ee(e,"severity")&&"none"!==e}(d)&&n.h(ze,{variant:"banner",severity:d,translations:l}),n.h(le,{direction:"column",flex:"1"},n.h(He,null,n.h(De,{variant:"banner",text:h}),Ee(g,"timestamp")&&n.h(Fe,{variant:"banner",value:g})),n.h(Oe,{variant:"banner",item:Object.assign(Object.assign({},i),{index:o}),renderer:r})),"on"===u&&n.h(xe,{buttonRenderer:e,title:null==l?void 0:l.close,variant:"banner",onAction:v})))}
/**
     * @license
     * Copyright (c) %FIRST_YEAR% %CURRENT_YEAR%, Oracle and/or its affiliates.
     * The Universal Permissive License (UPL), Version 1.0
