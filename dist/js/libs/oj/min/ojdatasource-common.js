...
/*
 ...
 http://jquery.org/license
*/
define(["ojs/ojcore","jquery"],function(b){b.Ui=function(b){this.data=b;this.Init()};o_("DataSource",b.Ui,b);b.b.ga(b.Ui,b.Mg,"oj.DataSource");b.Ui.prototype.Init=function(){b.Ui.q.Init.call(this)};b.b.g("DataSource.prototype.Init",{Init:b.Ui.prototype.Init});b.tp=function(f){b.tp.q.constructor.call(this,f)};o_("TreeDataSource",b.tp,b);b.b.ga(b.tp,b.Ui,"oj.TreeDataSource");b.T=function(f,a){if(this.constructor==b.T)throw Error(b.T.fc.Qqa+"\n"+b.T.fc.Pqa);this.data=f;this.options=a;this.$=0;this.Init()};
...
b);b.b.ga(b.Um,b.Ui,"oj.DataGridDataSource")});