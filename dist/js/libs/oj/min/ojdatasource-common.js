...
/**
   ...
   */
const r=function(e){this.data=e,this.Init()};a._registerLegacyNamespaceProp("DataSource",r),a.Object.createSubclass(r,a.EventSource,"oj.DataSource"),r.prototype.Init=function(){r.superclass.Init.call(this)};
/**
   * @license
   * Copyright (c) 2014, 2021, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
const o=function(e){o.superclass.constructor.call(this,e)};t._registerLegacyNamespaceProp("DataGridDataSource",o),t.Object.createSubclass(o,t.DataSource,"oj.DataGridDataSource");
/**
   * @license
   * Copyright (c) 2014, 2021, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
const c=function(e){c.superclass.constructor.call(this,e)};a._registerLegacyNamespaceProp("DiagramDataSource",c),a.Object.createSubclass(c,a.DataSource,"oj.DiagramDataSource"),c.EventType={ADD:"add",REMOVE:"remove",CHANGE:"change"};
/**
   * @license
   * Copyright (c) 2014, 2021, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
...
/**
   ...
   * @ignore
   */
const u=function(e){u.superclass.constructor.call(this,e)};t._registerLegacyNamespaceProp("TreeDataSource",u),t.Object.createSubclass(u,t.DataSource,"oj.TreeDataSource");
/**
   * @license
   * Copyright (c) 2014, 2021, Oracle and/or its affiliates.
   * The Universal Permissive License (UPL), Version 1.0
   ...
   * @ignore
   */
var n={};n.DataGridDataSource=oj.DataGridDataSource,e.DataGridDataSource=o,e.DataSource=r,e.DataSourceCommon=n,e.DiagramDataSource=c,e.TableDataSource=s,e.TreeDataSource=u,Object.defineProperty(e,"__esModule",{value:!0})});
