...
(function(){a.X9={};a.X9.register=function(){function a(){var b=window.Reflect;return"undefined"!==typeof b?b.construct(HTMLElement,[],this.constructor):HTMLElement.call(this)}var c=Object.create(HTMLElement.prototype);Object.defineProperty(c,"_activate",{value:function(){this._activateDescedantBindings?(this._savedChildNodes&&(this.appendChild(this._savedChildNodes),delete this._savedChildNodes),this._activateDescedantBindings()):Object.defineProperty(this,"_shown",{configurable:!1,value:!0})},writable:!1});
Object.defineProperty(c,"constructor",{value:a,writable:!0,configurable:!0});a.prototype=c;Object.setPrototypeOf(a,HTMLElement);customElements.define("oj-defer",a)};a.X9.register()})();(function(){a.tO.dT({nodeHasBindings:function(a,c){return c||1===a.nodeType&&"oj-defer"===a.nodeName.toLowerCase()},getBindingAccessors:function(a,c,e){1===a.nodeType&&"oj-defer"===a.nodeName.toLowerCase()&&(e=e||{},e._ojDefer_=function(){});return e}})})()});