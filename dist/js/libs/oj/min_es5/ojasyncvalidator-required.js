 ...
 */
return function(n){function l(t){var e;return function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,l),(e=i(this,c(l).call(this,t))).options=t,e}var a,p,s;return function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function");t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&&f(t,e)}(l,o),a=l,(p=[{key:"_InitLoadingPromise",value:function(){this._loadingPromise||(this._loadingPromise=t.__getRequirePromise("./ojvalidator-required",e))}},{key:"hint",get:function(){return u(c(l.prototype),"_GetHint",this).call(this)}}])&&r(a.prototype,p),s&&r(a,s),l}()});