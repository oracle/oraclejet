...
export declare function getDtMetadataForEvent(propDeclaration: ts.PropertyDeclaration, typeName: string, typeNode: ts.TypeNode | undefined, isCancelable: boolean, metaUtilObj: MetaTypes.MetaUtilObj): Metadata.ComponentMetadataEvents;
