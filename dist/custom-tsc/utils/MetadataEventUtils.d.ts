...
export declare function getDtMetadataForEvent(propDeclaration: ts.PropertyDeclaration, typeName: string, typeNode: ts.TypeNode | undefined, metaUtilObj: MetaTypes.MetaUtilObj): Metadata.ComponentMetadataEvents;
