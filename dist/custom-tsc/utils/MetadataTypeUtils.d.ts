...
export declare function getComplexPropertyMetadata(memberSymbol: ts.Symbol, metaObj: MetaTypes.ALL_TYPES, outerType: string, scope: MetaTypes.MDScope, context: MetaTypes.MDContext, propertyPath: string[], nestedArrayStack: string[], metaUtilObj: MetaTypes.MetaUtilObj, seenTypeDefs?: Set<string>): MetaTypes.ComplexPropertyMetadata;
