...
export declare function getDtMetadata(objWithJsDoc: ts.HasJSDoc, flags: MetaTypes.MDFlags, propertyPath: string[] | null, metaUtilObj: MetaTypes.MetaUtilObj): MetaTypes.AllMetadataTypes;
