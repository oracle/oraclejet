...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'jquery': path.resolve(__dirname, './web/js/libs/jquery/jquery-3.7.1'),
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/18.0.0/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/18.0.0/resources'),
      ...
      // it back to "../amd" because mixing require and es imports will not
      // bundle the css imports.
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/18.0.0"
      }
    )
