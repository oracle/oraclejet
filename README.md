...
See the [Oracle JET Developer Guide](http://www.oracle.com/pls/topic/lookup?ctx=jetlatest&id=homepage) for complete installation details, including prerequisites.
...
Oracle JET comes with a full [Developers Guide](http://www.oracle.com/pls/topic/lookup?ctx=jetlatest&id=homepage) to help with Getting Started and many common issues.
...
Copyright (c) 2026 Oracle and/or its affiliates and released under the
